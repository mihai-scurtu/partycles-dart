...
["dart.dom.html", "dart:html", , W, {
  ...
  HtmlElement: {
    "^": "Element;",
    "%": "HTMLAppletElement|HTMLBRElement|HTMLBaseElement|HTMLBodyElement|HTMLButtonElement|HTMLContentElement|HTMLDListElement|HTMLDataListElement|HTMLDetailsElement|HTMLDialogElement|HTMLDirectoryElement|HTMLDivElement|HTMLFieldSetElement|HTMLFontElement|HTMLFrameElement|HTMLFrameSetElement|HTMLHeadElement|HTMLHeadingElement|HTMLHtmlElement|HTMLKeygenElement|HTMLLIElement|HTMLLabelElement|HTMLLegendElement|HTMLLinkElement|HTMLMapElement|HTMLMarqueeElement|HTMLMenuElement|HTMLMetaElement|HTMLMeterElement|HTMLModElement|HTMLOListElement|HTMLOptGroupElement|HTMLOptionElement|HTMLOutputElement|HTMLParagraphElement|HTMLParamElement|HTMLPreElement|HTMLProgressElement|HTMLQuoteElement|HTMLScriptElement|HTMLShadowElement|HTMLSourceElement|HTMLSpanElement|HTMLStyleElement|HTMLTableCaptionElement|HTMLTableCellElement|HTMLTableColElement|HTMLTableDataCellElement|HTMLTableElement|HTMLTableHeaderCellElement|HTMLTableRowElement|HTMLTableSectionElement|HTMLTemplateElement|HTMLTextAreaElement|HTMLTitleElement|HTMLTrackElement|HTMLUListElement|HTMLUnknownElement;HTMLElement"
  },
  AnchorElement: {
    "^": "HtmlElement;",
    toString$0: function(receiver) {
...
["force", "package:partycles/force.dart", , L, {
  ...
  Force: {
    "^": "Object;x>,y>",
    $add: function(_, f) {
      var t1 = J.getInterceptor$x(f);
      return new L.Force(t1.get$x(f).$add(0, this.x), t1.get$y(f).$add(0, this.y));
    },
    $eq: function(_, f) {
      var t1;
      if (f == null)
      ...
      return this.x === t1.get$x(f) && this.y === t1.get$y(f);
    },
    Force$random$2$rng: function(degree, rng) {
      var r, theta;
      r = C.C__JSRandom.nextDouble$0() * degree;
      theta = C.C__JSRandom.nextDouble$0() * 2 * 3.141592653589793;
...
["particle_engine", "package:partycles/particle_engine.dart", , M, {
  "^": "",
  ParticleEngine: {
    "^": "Object;particles,canvas,rng,physicsCallback,drawCallback,exit,scale,width,height,textBuffer,stopwatch,averageFPS,targetFPS,delta,frameTime",
    physicsCallback$1: function(arg0) {
      return this.physicsCallback.call$1(arg0);
    },
    drawCallback$1: function(arg0) {
      return this.drawCallback.call$1(arg0);
    },
    loop$1: [function(_, time) {
      var t1, fps;
      if (time == null) {
        C.Window_methods.get$animationFrame(window).then$1(this.get$loop(this));
        return;
      }
      this.delta = J.abs$0$n(J.$sub$n(this.frameTime, time));
      this.frameTime = time;
      this.textBuffer = "";
      t1 = this.canvas;
      ...
      t1 = this.delta;
      if (t1 > 0) {
        fps = C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(1000 / t1));
        t1 = this.averageFPS;
        if (t1 == null) {
          this.averageFPS = fps;
          t1 = fps;
        ...
        t1 = "FPS: " + C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(t1));
        this.textBuffer = this.textBuffer + (t1 + "\n ");
      }
      ...
      return this.loop$1($receiver, null);
    }, "loop$0", "call$1", "call$0", "get$loop", 0, 2, 19, 4],
    updatePhysics$0: function() {
      var t1, p, t2, t3, t4;
      this.physicsCallback$1(this);
      for (t1 = this.particles, t1 = new H.ListIterator(t1, t1.length, 0, null); t1.moveNext$0();) {
        p = t1._current;
        t2 = J.get$x$x(p);
        t3 = p.get$force().x;
        t4 = this.delta;
        if (typeof t2 !== "number")
          return t2.$add();
        p.x = t2 + t3 * t4;
        p.y = p.y + p.force.y * t4;
      }
    },
    draw$0: function() {
      this.drawCallback$1(this);
      for (var t1 = this.particles, t1 = new H.ListIterator(t1, t1.length, 0, null); t1.moveNext$0();)
        this.drawParticle$1(t1._current);
      this.drawText$0();
    },
    drawParticle$1: function(p) {
      var t1, t2, t3;
      ...
      if (!t2)
        return;
      t2 = J.get$context2D$x(this.canvas);
      t2.fillStyle = t1.get$color(p);
      t2.beginPath();
      t3 = this.scale;
      t2.arc(t1.get$x(p) * t3, p.y * t3, p.radius, 0, 6.283185307179586, false);
      t2.closePath();
      t2.fill("nonzero");
    },
    drawText$0: function() {
      var t1, t2, t3, y, line, t4;
      t1 = this.textBuffer;
      if (t1.length === 0)
        return;
      for (t1 = t1.split("\n"), t1 = new H.ListIterator(t1, t1.length, 0, null), t2 = this.canvas, t3 = J.getInterceptor$x(t2), y = 25; t1.moveNext$0();) {
        line = t1._current;
        t4 = t3.get$context2D(t2);
        t4.font = "22px Courier";
        t4.fillStyle = "#000000";
        t4.toString;
        t4.fillText(line, 10, y);
        y += 25;
      }
    },
    ParticleEngine$1: function(canvas) {
      var t1, t2, t3, t4;
      t1 = this.canvas;
      ...
      if (typeof t3 !== "number")
        return t3.$div();
      this.width = C.JSNumber_methods.toInt$0(Math.floor(t3 / t4));
      t1 = t2.get$height(t1);
      if (typeof t1 !== "number")
        return t1.$div();
      this.height = C.JSNumber_methods.toInt$0(Math.floor(t1 / t4));
    }
  },
  closure: {
    "^": "Closure:10;",
    call$1: function(ParticleEngine) {
    }
  },
  closure0: {
    "^": "Closure:10;",
...
["partycles", "partycles.dart", , Z, {
  "^": "",
  main: [function() {
    var t1, engine;
    t1 = document.querySelector("canvas#main");
    engine = new M.ParticleEngine([], t1, C.C__JSRandom, new M.closure(), new M.closure0(), false, 2, null, null, "", new P.Stopwatch(1000000, null, null), null, 60, 0, 0);
    engine.ParticleEngine$1(t1);
    engine.drawCallback = new Z.main_closure();
    engine.loop$0(0);
  }, "call$0", "main$closure", 0, 0, 1],
  main_closure: {
    "^": "Closure:10;",
    call$1: function(engine) {
      var t1, p;
      t1 = engine.rng;
      p = new D.Particle("#000000", 2.5, null, t1.nextInt$1(engine.width), t1.nextInt$1(engine.height));
      p.force = new L.Force(0, 0);
      t1 = new L.Force(0, 0);
      t1.Force$random$2$rng(0.2, null);
      p.force = t1;
      t1 = engine.particles;
      t1.push(p);
      t1 = "Particles: " + t1.length;
      engine.textBuffer = engine.textBuffer + (t1 + "\n ");
    }
  }
},
1],
  ...
  Point: {
    ...
    $eq: function(_, p) {
      ...
      if (p == null)
        return false;
      t1 = J.getInterceptor$x(p);
      return this.x === t1.get$x(p) && this.y === t1.get$y(p);
    }
  }
}],
]);
...
function dart_precompiled($collectedClasses) {
  ...
  Force.builtin$cls = "Force";
  if (!"name" in Force)
    Force.name = "Force";
  $desc = $collectedClasses.Force;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Force.prototype = $desc;
  Force.prototype.get$x = function(receiver) {
    return this.x;
  };
  Force.prototype.get$y = function(receiver) {
    return this.y;
  };
  function Particle(color, radius, force, x, y) {
    this.color = color;
    this.radius = radius;
    this.force = force;
    this.x = x;
  ...
  Particle.prototype.get$color = function(receiver) {
    return this.color;
  };
  Particle.prototype.get$force = function() {
    return this.force;
  };
  function ParticleEngine(particles, canvas, rng, physicsCallback, drawCallback, exit, scale, width, height, textBuffer, stopwatch, averageFPS, targetFPS, delta, frameTime) {
  ...
  ParticleEngine.builtin$cls = "ParticleEngine";
  if (!"name" in ParticleEngine)
    ParticleEngine.name = "ParticleEngine";
  $desc = $collectedClasses.ParticleEngine;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ParticleEngine.prototype = $desc;
  function closure() {
  }
  closure.builtin$cls = "closure";
  if (!"name" in closure)
