...
["force", "package:partycles/force.dart", , L, {
  ...
  Force: {
    ...
    $add: function(_, f) {
      return new L.Force(f.get$x() + this.x, f.get$y() + this.y);
    },
    $eq: function(_, f) {
      if (f == null)
        return false;
...
["force_test", "force_test.dart", , V, {
  "^": "",
  main: [function() {
    N.test("Addition", new V.main_closure());
    N.test("Random", new V.main_closure0());
    N.test("Absolute value", new V.main_closure1());
  ...
  main_closure: {
    ...
    call$0: function() {
      ...
      f = new L.Force(4, 5);
      g = new L.Force(4, 5);
      Y.expect(f.$eq(0, g), true, null, null, false);
      Y.expect(f.$add(0, g), new L.Force(8, 10), null, null, false);
    },
    $isFunction: true
  },
  main_closure0: {
    ...
    call$0: function() {
      var f, t1;
      f = new L.Force(0, 0);
      f.Force$random$2$rng(5, null);
      t1 = f.x;
      Y.expect(t1 > -5 && t1 < 5, true, null, null, false);
      t1 = f.y;
      Y.expect(t1 > -5 && t1 < 5, true, null, null, false);
      Y.expect(f.get$abs(f) < 5, true, null, null, false);
    },
    $isFunction: true
  },
  main_closure1: {
    "^": "Closure:50;",
    call$0: function() {
      var f = new L.Force(0, 1);
      Y.expect(f.get$abs(f), 1, null, null, false);
      f = new L.Force(1, 1);
      Y.expect(f.get$abs(f), new F._IsCloseTo(1.41, 0.01), null, null, false);
      f = new L.Force(-1, -1);
      Y.expect(f.get$abs(f), new F._IsCloseTo(1.41, 0.01), null, null, false);
    },
    $isFunction: true
...
["matcher.core_matchers", "package:matcher/src/core_matchers.dart", , O, {
  ...
  _DeepMatcher: {
    ...
    _recursiveMatch$4: [function(expected, actual, $location, depth) {
      var e, t1, t2, t3, exception, key, rp, description;
      if (!!J.getInterceptor(expected).$isMatcher) {
        if (expected.matches$2(actual, P.LinkedHashMap_LinkedHashMap$_empty(null, null)))
          return;
        t1 = new P.StringBuffer("");
        t1._contents = "";
        t1._contents = "";
        t2 = expected;
        t1._contents = "a numeric value within ";
        t3 = t2.get$_delta();
        t3 = S.prettyPrint(t3, 25, 80);
        t1._contents += t3;
        t1._contents += " of ";
        t2 = t2.get$_numeric_matchers$_value();
...
["matcher.numeric_matchers", "package:matcher/src/numeric_matchers.dart", , F, {
  "^": "",
  _IsCloseTo: {
    "^": "Matcher;_numeric_matchers$_value<,_delta<",
    matches$2: function(item, matchState) {
      var diff;
      if (typeof item !== "number")
        return false;
      diff = item - this._numeric_matchers$_value;
      if (diff < 0)
        diff = -diff;
    ...
    describe$1: function(description) {
      var t1;
      description._out.write$1("a numeric value within ");
      t1 = description.addDescriptionOf$1(this._delta);
      t1._out.write$1(" of ");
      return t1.addDescriptionOf$1(this._numeric_matchers$_value);
    },
    describeMismatch$4: function(item, mismatchDescription, matchState, verbose) {
      var diff;
      if (typeof item !== "number") {
        mismatchDescription._out.write$1(" not numeric");
        return mismatchDescription;
      } else {
        diff = item - this._numeric_matchers$_value;
        if (diff < 0)
          diff = -diff;
        mismatchDescription._out.write$1(" differs by ");
...
function dart_precompiled($collectedClasses) {
  ...
  Force.prototype.get$x = function() {
    return this.x;
  };
  Force.prototype.get$y = function() {
    return this.y;
  };
  ...
  function _IsCloseTo(_numeric_matchers$_value, _delta) {
  ...
  _IsCloseTo.prototype.get$_numeric_matchers$_value = function() {
    return this._numeric_matchers$_value;
  };
