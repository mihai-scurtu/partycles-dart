...
["point", "package:partycles/point.dart", , K, {
  ...
  Point: {
    "^": "Object;x<,y<",
    distanceTo$1: function(p) {
      var t1, t2;
      t1 = Math.pow(this.x - p.x, 2);
      t2 = Math.pow(this.y - p.y, 2);
...
["point_test", "point_test.dart", , K, {
  "^": "",
  main: [function() {
    N.test("Identical points", new K.main_closure());
    N.test("Distance", new K.main_closure0());
    N.test("Equality", new K.main_closure1());
  }, "call$0", "main$closure", 0, 0, 14],
  main_closure: {
    "^": "Closure:50;",
    call$0: function() {
      Y.expect(new K.Point(0, 0).distanceTo$1(new K.Point(0, 0)), 0, null, null, false);
    },
    $isFunction: true
  },
  main_closure0: {
    "^": "Closure:50;",
    call$0: function() {
      Y.expect(new K.Point(1, 1).distanceTo$1(new K.Point(0, 0)), new F._IsCloseTo(1.41, 0.01), null, null, false);
    },
    $isFunction: true
  },
  main_closure1: {
    "^": "Closure:50;",
    call$0: function() {
      Y.expect(new K.Point(5, 4).$eq(0, new K.Point(5, 4)), true, null, null, false);
    },
    $isFunction: true
  }
},
